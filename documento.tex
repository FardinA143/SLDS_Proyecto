...
El software libre representa una alternativa importante en el ecosistema de dispositivos móviles actual, con especial relevancia en sistemas basados en Android. Vamos a analizar la disponibilidad de aplicaciones libres en las principales categorías, cuales son sus principales alternativas propietarias y la información esencial para comprender este segmento del desarrollo de software móvil.

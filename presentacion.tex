...
\section{SO Libres en Dispositivos Móviles}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item ...\vspace{2pt}
	\end{itemize}
	\item Luego Google ofrece este sistema operativo a terceros, a parte de usarlo en sus propios dispositivos
\end{itemize}
\end{frame}
...
\end{center}
\begin{center}
    \large ¿Qué hay detrás del software libre en tu móvil?
    \vspace{5pt}
    \\ Explorando el desarrollo, los costes y la difusión del software libre en el ámbito móvil
\end{center}
\end{frame}
...
\begin{center}
\large \textbf{¿Dónde viven las apps libres?}
\end{center}
...
\vspace{0.3cm}
\begin{center}
\textit{¿Cómo afectaría esto a un desarrollador independiente?}
\end{center}
...
\begin{itemize}
	...
	\item Ya existen alternativas muy usables y buenas a partir de forks del AOSP como \textbf{GraoheneOS o LineageOS} \vspace{10pt}

...
\section{Aplicaciones de Software Libre para Móviles}

\begin{frame}
\frametitle{Aplicaciones de Software Libre para Móviles}
\begin{center}
    \Huge \textbf{Aplicaciones de Software Libre para Móviles}
\end{center}
\begin{center}
    \Large Relevancia importante para sistemas móviles.
\end{center}
\end{frame}

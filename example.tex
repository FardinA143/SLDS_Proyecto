...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item El SL permite auditar y verificar el código \vspace{3pt}
    \end{itemize} \vspace{5pt}
...
\begin{frame}
\frametitle{Conclusión del bloque}

\begin{itemize}
    \item \textbf{SL = negocio viable} \vspace{5pt}
    \begin{itemize}
        \item Se puede generar ingresos mediante modelos alternativos \vspace{3pt}
        \item Donaciones, freemium, publicidad ética y desarrollo por encargo \vspace{3pt}
    \end{itemize} \vspace{5pt}

    \item \textbf{SL = más seguridad y transparencia} \vspace{5pt}
    \begin{itemize}
    ...
    \item \textbf{Futuro: más dispositivos abiertos} \vspace{5pt}
    \begin{itemize}
        \item Aumento de sistemas móviles libres y alternativos \vspace{3pt}
        \item Mayor relevancia conforme crece la preocupación por la privacidad \vspace{3pt}
    \end{itemize}
\end{itemize}

...
\section{Software Libre en Aplicaciones Móviles: Aplicaciones de Software Libre para Móviles}

\begin{frame}
\frametitle{Software Libre en Aplicaciones Móviles: Aplicaciones de Software Libre para Móviles}
\begin{center}
    \Huge \textbf{Aplicaciones de Software Libre para Móviles}
\end{center}
\begin{center}
    \Large Representa una alternativa importante en el ecosistema de dispositivos móviles actual, con especial relevancia en sistemas basados en Android.
\end{center}
\end{frame}
